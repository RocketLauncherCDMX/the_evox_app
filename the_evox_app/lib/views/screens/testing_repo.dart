                            ...
                            child: SizedBox(
                               ...
                               * then proceed to signin intend */
                                 ...
                                 * object and stores the ID of created db doc */
                                      newUserProfile.profileDocId = await _profileRepository
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  if (signedProfile != null) {
                                    ...
                                    try {
                                      await _homeRepository!.createHome(newHome);
                                    ...
                                    if (signedProfile!.homes != null) {
                                      if (signedProfile!.homes!.length >= 2) {
                                        HomeModel updatedHome = HomeModel(
                                            ...
                                            images:
                                                (List<String>.of(signedProfile!.homes![1].images!)
                                                  ..add("https://google.com")),
                                            rooms: signedProfile!.homes![1].rooms);
                                        try {
                                          await _homeRepository!
                                              .updateHome(signedProfile!.homes![1], updatedHome);
                                    ...
                                    if (signedProfile!.homes != null) {
                                      if (signedProfile!.homes!.isNotEmpty) {
                                        HomeModel home2Delete = signedProfile!
                                            .homes![(signedProfile!.homes!.length - 1)];
                                        try {
                                          await _homeRepository!.deleteHome(home2Delete);
                                        ...
                                        print("No homes found, Add at least 1 to perform delete");
                                      }
                                    } else {
                                      print(
                                          "No homes found on this user, Add at least 2 to perform update on home n.2");
